  ...
  return (
    <section className="page terms">
      ...
      <div className="terms__body">
        ...
        {/* ── 6 ── */}
        <h2 className="terms__heading">6. Cookies</h2>

        <p>
          We use cookies and similar local storage technologies to keep our
          website secure, reliable, and functioning properly. These are
          strictly necessary for core experiences such as login, session
          continuity, and security.
        </p>

        <p>
          When you see our cookie banner, you can choose:
        </p>

        <ul className="terms__list terms__list--bullet">
          <li>
            <strong>Accept</strong>, which allows optional measurement and
            marketing-related technologies in addition to necessary cookies.
          </li>
          <li>
            <strong>Close</strong>, which dismisses the banner and keeps only
        ...
        <p>
          ...
          Disabling certain cookies may affect how parts of the website work.
        </p>
