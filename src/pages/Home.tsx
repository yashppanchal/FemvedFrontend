  ...
  return (
    <div className="home">
      ...
      <p className="page__lead">
        ...
        choosing awareness, independence, and self-work.
      </p>

      <div className="card">
        <h2 className="card__title">What we’re building (MVP)</h2>
        <p className="card__text">
          An insider meet-up platform for women’s wellness — helping you match
          with trusted experts, choose programs that fit your life stage, and
          make conscious healthy living feel natural in everyday life.
        </p>
      </div>
